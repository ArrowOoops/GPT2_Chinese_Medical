...
# with open('D:\\VSCode\\GPT2-Chinese\\data\\valid.txt', 'r', encoding='utf8') as f:
#     for line in tqdm(f):
#         l = line.strip()
#         token_l = full_tokenizer.convert_tokens_to_ids(full_tokenizer.tokenize(l))
#         if len(token_l) >= 20 and len(token_l) <= 1024:
...
# with open('D:\\VSCode\\GPT2-Chinese\\data\\valid_tok.txt', 'w', encoding='utf8') as f:
#     for ids in all_ids:
#         for id in ids:
#             f.write(str(id) + ' ')
#         f.write('\n')
...
with open('D:\\VSCode\\GPT2-Chinese\\data\\test.txt', 'r', encoding='utf8') as f:
    for line in tqdm(f):
        l = line.strip()
        token_l = full_tokenizer.convert_tokens_to_ids(full_tokenizer.tokenize(l))
        if len(token_l) >= 20 and len(token_l) <= 1024:
...
with open('D:\\VSCode\\GPT2-Chinese\\data\\test_tok.txt', 'w', encoding='utf8') as f:
    for ids in all_ids:
        for id in ids:
            f.write(str(id) + ' ')
        f.write('\n')